...
You have X amount of money and you want to reach X+Y amount of money. You win or loose one unit of money each time you play with a Z percent of winning chance.
...
main(){
    ...
    sampleSpaceSize=1000;//Increase this in order to have more realistic results. Increasing this will slow down the performance.
    ...
    j=rand()%10000;
    if(j<winCondition) //If you get the number lower than you need to, you lose one unit of money.
    money--;
    ...
    //Number of wins means you won that many out of sampleSpaceSize
